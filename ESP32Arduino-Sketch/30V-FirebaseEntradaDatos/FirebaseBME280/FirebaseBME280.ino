...
#define API_KEY "AIzaSyBd__iGve2EGkFPOhoukvATHhmlwd8m3-w"

// 3. Define RTDB (real time data base) URL
#define DATABASE_URL "https://esp32-bme280-13e27-default-rtdb.asia-southeast1.firebasedatabase.app/" //<databaseName>.firebaseio.com or <databaseName>.<region>.firebasedatabase.app

// 4. Define el correo y contraseña del usuario registrado (Autentificación por e-mail)
#define USER_EMAIL "maria@correo.com"
